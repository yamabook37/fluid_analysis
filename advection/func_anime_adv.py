...
if(YAMAMOTO_MP4 == 1):
  ani.save("animes/advection_anime.mp4", writer="ffmpeg")
# gif ファイルとして保存 yamamoto 用
if(YAMAMOTO_GIF == 1):
  ani.save("animes/advection_anime.gif", writer="imagemagick")
# gif ファイルとして保存 mushano 用
if(MUSHANO_GIF == 1):
  ani.save("animes/advection_anime.gif", writer="pillow")
if(HTML_SHOW == 1):
