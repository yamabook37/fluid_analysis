...
"""
最終更新： 2020/1/23　22：00
編集者：っどひ

一応英語原文もそのまま載せてあります
もう知ってそうだなってところは説明省いてます
...
#subplots(2×2個の図を表示、figsizeはインチ)
...
# --- Custom colormaps ---
#dictで辞書に要素を登録。色ごとに値の大きさで濃淡をどう変化させるかきめている。
#このあたりはcolorberをいじりたいときに使えばいいので今はいらないかも
...
#plt.rcParams["調整したいパラメータ"] = (値)でデフォルト設定をオーバーライドできる
#これで図の大枠、フォント、目盛線、グリッド、凡例などいっろいろ変えられるみたい
